        ...
        <div className="sidebar bg-white">
            <div className="sidebar-logo-holder justify-between">
                <div className="flex items-center text-gray-600 hover:text-gray-800">
                    ...
                    <Link onClick={closeSidebar} to={`/${currentTenant}/admin/dashboard`}
                          className="mr-2 font-bold text-gray-600 hover:text-gray-800">پنل مدیریت</Link>
                </div>
                <button onClick={() => toggleSidebar(false)} className="show-on-phone btn-svg btn btn-ghost btn-sm">
                    <ReactSVG src="/src/assets/svgs/X.svg" className="logo"/>
                </button>
            </div>
            <ul className="menu text-sm bg-base-100 p-2 rounded-box items-center text-gray-500 overflow-y-auto">
                <li className="w-60 mb-1">
                    <NavLink onClick={closeSidebar} end className={({isActive}) => (isActive ? 'active' : undefined)}
                             to={`/${currentTenant}/admin/dashboard`}>
                ...
                <DropDownMenu hasPermissions={['UsersList', 'RolesList', 'PermissionsList']} title="کاربران"
                              icon="/src/assets/svgs/users.svg">
                    {
                        permissions.includes('UsersList') ?
                            <li>
                                <NavLink onClick={closeSidebar} end to={`/${currentTenant}/admin/users`}
                    ...
                    }
                    {
                        permissions.includes('RolesList') ?
                            <li>
                                <NavLink onClick={closeSidebar} end to={`/${currentTenant}/admin/users/roles`}
                                         className={({isActive}) => (isActive ? 'active' : undefined)}>
                    ...
                    }
                    {
                        permissions.includes('PermissionsList') ?
                            <li>
                                <NavLink onClick={closeSidebar} end
                                         to={`/${currentTenant}/admin/users/roles/permissions`}
                                         className={({isActive}) => (isActive ? 'active' : undefined)}>
                ...
                <DropDownMenu hasPermissions={['CategoriesList', 'DepartmentsList', 'CreateTicket', 'TicketsList']}
                              title="تیکتینگ" icon="/src/assets/svgs/inbox.svg">
                    {
                        permissions.includes('CategoriesList') ?
                            <li>
                                <NavLink onClick={closeSidebar} end to={`/${currentTenant}/admin/ticketing/categories`}
                                         className={({isActive}) => (isActive ? 'active' : undefined)}>
                    ...
                    }
                    {
                        permissions.includes('DepartmentsList') ?
                            <li>
                                <NavLink onClick={closeSidebar} end to={`/${currentTenant}/admin/ticketing/departments`}
                                         className={({isActive}) => (isActive ? 'active' : undefined)}>
                    ...
                    }
                    {
                        permissions.includes('CreateTicket') ?
                            <li>
                                <NavLink onClick={closeSidebar} end to={`/${currentTenant}/admin/ticketing/create`}
                                         className={({isActive}) => (isActive ? 'active' : undefined)}>
                    ...
                    }
                    {
                        permissions.includes('TicketsList') ?
                            <li>
                                <NavLink onClick={closeSidebar} end to={`/${currentTenant}/admin/ticketing`}>
