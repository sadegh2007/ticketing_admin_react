...
const DashboardLayout = (props) => {
    ...
    return (
        <div className={showSidebar ? "flex flex-row justify-between sidebar-open" : 'flex flex-row justify-between sidebar-close'}>
            <Sidebar/>

            <div className="main-content">
                <MainLoader show={showMainLoader}/>

                <div className="panel-navbar navbar mb-4">
