        ...
        <>
            ...
            <div className="mt-2 flex items-baseline justify-between">
                ...
                <ReactPaginate
                    ...
                    breakLinkClassName="btn btn-sm rounded btn-ghost btn-outline ml-1"
                    pageLinkClassName="btn btn-sm rounded btn-ghost btn-outline ml-1"
                    activeLinkClassName="btn-active"
                    nextLinkClassName="btn btn-sm rounded btn-ghost btn-outline ml-1"
                    previousLinkClassName="btn btn-sm rounded btn-ghost btn-outline"
